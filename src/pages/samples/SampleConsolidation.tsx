...
import { PackageIcon, CopyIcon, QrCodeIcon, ClipboardIcon, PlusIcon, ImageIcon, CheckIcon, ArrowRightIcon, TruckIcon, ScaleIcon, BoxIcon, DownloadIcon, PrinterIcon, AlertCircleIcon, ClockIcon, CheckCircleIcon, DollarSignIcon, MapPinIcon, CalendarIcon, ExternalLinkIcon } from 'lucide-react';
          ...
          {loadingShipments ? (
            ...
            <Card>
              <div className="text-center py-12">
                ...
                <p className="text-gray-500 mt-2">Go to the Samples in Warehouse tab to request shipments.</p>
              </div>
            </Card>
          ) : (
              ...
              {shipmentRequests.map((request) => (
                <Card key={request.id}>
                  <div className="p-6">
                      ...
                      <div className="mb-4 flex items-start justify-between gap-4">
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <button
                              onClick={() => {
                                navigator.clipboard.writeText(request.tracking_number!).then(() => {
                    ...
                    <div>
                      <button
                        onClick={() => setSelectedShipmentRequest(selectedShipmentRequest?.id === request.id ? null : request)}
                        className="text-sm text-[#00b4d8] hover:text-[#0096b8] font-medium"
                      >
                        {selectedShipmentRequest?.id === request.id ? 'Hide' : 'View'} Sample Details
                      </button>
                    </div>
