        ...
        <ul className="space-y-1">
          <li>
            <Link
              ...
              className={`flex items-center ${isCollapsed ? 'justify-center' : ''} px-3 py-2.5 rounded-lg ${
                isActive('/admin') ? 'bg-[#00b4d8]/10 text-[#00b4d8]' : 'text-gray-700 hover:bg-gray-50'
              } min-h-[44px]`}
            >
          ...
          <li>
            <button
              ...
              className={`flex items-center ${isCollapsed ? 'justify-center' : 'justify-between'} w-full px-3 py-2.5 rounded-lg ${
                isGroupActive('/admin/users') ? 'bg-[#00b4d8]/10 text-[#00b4d8]' : 'text-gray-700 hover:bg-gray-50'
              } min-h-[44px]`}
            >
              ...
              <ul className="mt-1 ml-7 space-y-1">
                <li>
                  <Link
                    ...
                    className={`flex items-center px-3 py-2 rounded-lg text-xs ${
                      isActive('/admin/users/customers') ? 'bg-[#00b4d8]/10 text-[#00b4d8]' : 'text-gray-600 hover:bg-gray-50'
                    } min-h-[36px]`}
                  >
                    Customers
                  </Link>
                ...
                <li>
                  <Link
                    ...
                    onClick={handleLinkClick}
                    className={`flex items-center px-3 py-2 rounded-lg text-xs ${
                      isActive('/admin/users/staff') ? 'bg-[#00b4d8]/10 text-[#00b4d8]' : 'text-gray-600 hover:bg-gray-50'
                    } min-h-[36px]`}
                  >
                    Staff Members
                  </Link>
                ...
                <li>
                  <Link
                    ...
                    onClick={handleLinkClick}
                    className={`flex items-center px-3 py-2 rounded-lg text-xs ${
                      isActive('/admin/users/admins') ? 'bg-[#00b4d8]/10 text-[#00b4d8]' : 'text-gray-600 hover:bg-gray-50'
                    } min-h-[36px]`}
                  >
                    Administrators
                  </Link>
          ...
          <li>
            <Link
              ...
              onClick={handleLinkClick}
              className={`flex items-center ${isCollapsed ? 'justify-center' : ''} px-3 py-2.5 rounded-lg ${
                isActive('/admin/analytics') ? 'bg-[#00b4d8]/10 text-[#00b4d8]' : 'text-gray-700 hover:bg-gray-50'
              } min-h-[44px]`}
            >
          ...
          <li>
            <Link
              ...
              onClick={handleLinkClick}
              className={`flex items-center ${isCollapsed ? 'justify-center' : ''} px-3 py-2.5 rounded-lg ${
                isActive('/admin/audit-logs') ? 'bg-[#00b4d8]/10 text-[#00b4d8]' : 'text-gray-700 hover:bg-gray-50'
              } min-h-[44px]`}
            >
          ...
          <li>
            <button
              ...
              className={`flex items-center ${isCollapsed ? 'justify-center' : 'justify-between'} w-full px-3 py-2.5 rounded-lg ${
                isGroupActive('/admin/system') ? 'bg-[#00b4d8]/10 text-[#00b4d8]' : 'text-gray-700 hover:bg-gray-50'
              } min-h-[44px]`}
            >
              <div className="flex items-center">
              ...
              <ul className="mt-1 ml-7 space-y-1">
                <li>
                  <Link
                    ...
                    onClick={handleLinkClick}
                    className={`flex items-center px-3 py-2 rounded-lg text-xs ${
                      isActive('/admin/system/general') ? 'bg-[#00b4d8]/10 text-[#00b4d8]' : 'text-gray-600 hover:bg-gray-50'
                    } min-h-[36px]`}
                  >
                    General Settings
                  </Link>
                ...
                <li>
                  <Link
                    to="/admin/system/integrations"
                    onClick={handleLinkClick}
                    className={`flex items-center px-3 py-2 rounded-lg text-xs ${
                      isActive('/admin/system/integrations') ? 'bg-[#00b4d8]/10 text-[#00b4d8]' : 'text-gray-600 hover:bg-gray-50'
                    } min-h-[36px]`}
                  >
                    Integrations
                  </Link>
                ...
                <li>
                  <Link
                    ...
                    onClick={handleLinkClick}
                    className={`flex items-center px-3 py-2 rounded-lg text-xs ${
                      isActive('/admin/system/notifications') ? 'bg-[#00b4d8]/10 text-[#00b4d8]' : 'text-gray-600 hover:bg-gray-50'
                    } min-h-[36px]`}
                  >
                    Notifications
                  </Link>
                ...
                <li>
                  <Link
                    ...
                    onClick={handleLinkClick}
                    className={`flex items-center px-3 py-2 rounded-lg text-xs ${
                      isActive('/admin/system/email') ? 'bg-[#00b4d8]/10 text-[#00b4d8]' : 'text-gray-600 hover:bg-gray-50'
                    } min-h-[36px]`}
                  >
                    Email Settings
                  </Link>
          ...
          <li>
            <button
              ...
              className={`flex items-center ${isCollapsed ? 'justify-center' : 'justify-between'} w-full px-3 py-2.5 rounded-lg ${
                isGroupActive('/admin/security') ? 'bg-[#00b4d8]/10 text-[#00b4d8]' : 'text-gray-700 hover:bg-gray-50'
              } min-h-[44px]`}
            >
              <div className="flex items-center">
              ...
              <ul className="mt-1 ml-7 space-y-1">
                <li>
                  <Link
                    ...
                    onClick={handleLinkClick}
                    className={`flex items-center px-3 py-2 rounded-lg text-xs ${
                      isActive('/admin/security/roles') ? 'bg-[#00b4d8]/10 text-[#00b4d8]' : 'text-gray-600 hover:bg-gray-50'
                    } min-h-[36px]`}
                  >
                    Roles & Permissions
                  </Link>
                ...
                <li>
                  <Link
                    ...
                    onClick={handleLinkClick}
                    className={`flex items-center px-3 py-2 rounded-lg text-xs ${
                      isActive('/admin/security/api-keys') ? 'bg-[#00b4d8]/10 text-[#00b4d8]' : 'text-gray-600 hover:bg-gray-50'
                    } min-h-[36px]`}
                  >
                    API Keys
                  </Link>
